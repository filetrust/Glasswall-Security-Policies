...
The company requires that email sent to more than twenty (20) recipients external to the company have the following characteristics:
...
The user must not use the corporate email system to:
